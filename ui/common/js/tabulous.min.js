...
"scale")tab_content=this.$elem.find("div.tab-div").not(":first").not(":nth-child(1)").addClass("hidescale");else if(this.options.effect=="slideLeft")tab_content=this.$elem.find("div").not(":first").not(":nth-child(1)").addClass("hideleft");else if(this.options.effect=="scaleUp")tab_content=this.$elem.find("div.tab-div").not(":first").not(":nth-child(1)").addClass("hidescaleup");else if(this.options.effect=="flip")tab_content=this.$elem.find("div").not(":first").not(":nth-child(1)").addClass("hideflip");var firstdiv=
this.$elem.find("#tabs_container");var firstdivheight=firstdiv.find("div:first").height();var alldivs=this.$elem.find("div:first").find(".tab-div");alldivs.css({"position":"absolute","top":"0px"});firstdiv.css("height","300px");firstchild.addClass("tabulous_active").parent("li").addClass("tabulous_active");links.bind("click",{myOptions:this.options},function(e){e.preventDefault();var $options=e.data.myOptions;var effect=$options.effect;var mythis=$(this);var thisform=mythis.parent().parent().parent();var thislink=mythis.attr("href");
firstdiv.addClass("transition");links.removeClass("tabulous_active").parent("li").removeClass("tabulous_active");mythis.addClass("tabulous_active").parent("li").addClass("tabulous_active");thisdivwidth=thisform.find("div"+thislink).height();if(effect=="scale"){alldivs.removeClass("showscale").addClass("make_transist").addClass("hidescale");thisform.find("div"+thislink).addClass("make_transist").addClass("showscale")}else if(effect=="slideLeft"){alldivs.removeClass("showleft").addClass("make_transist").addClass("hideleft");thisform.find("div"+thislink).addClass("make_transist").addClass("showleft")}else if(effect==
"scaleUp"){alldivs.removeClass("showscaleup").addClass("make_transist").addClass("hidescaleup");thisform.find("div"+thislink).addClass("make_transist").addClass("showscaleup")}else if(effect=="flip"){alldivs.removeClass("showflip").addClass("make_transist").addClass("hideflip");thisform.find("div"+thislink).addClass("make_transist").addClass("showflip")}firstdiv.css("height","300px")})},yourOtherFunction:function(el,options){}};$.fn[pluginName]=function(options){return this.each(function(){new Plugin(this,
